...
def integrate(dt):
  ...
  def split(res):
    Ak = res[0:9].reshape((3, 3))
    Bk_0 = res[9:18].reshape((3, 3))
    Bk_1 = res[18:27].reshape((3, 3))
...
def solve(u_min, u_max):
  ...
  # print(Bk_0.T @ constr[0].dual_value)
  # print(Bk_1.T @ constr[N - 1].dual_value)

  # for i in range(1, N - 1):
  #  print(Bk_0.T @ constr[i].dual_value + Bk_1.T @ constr[i - 1].dual_value)
  print(Bk_0 + Ak @ Bk_1)
...
if __name__ == '__main__':
  Ak, Bk_0, Bk_1 = integrate(T_F / N)
  print(Ak, np.linalg.matrix_rank(Ak))
  print('est')
  print(Bk_0, np.linalg.matrix_rank(Bk_0))
  print('est')
  print(Bk_1, np.linalg.matrix_rank(Bk_1))
  exit()
